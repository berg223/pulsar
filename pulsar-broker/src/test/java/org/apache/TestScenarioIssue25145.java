...
public class TestScenarioIssue25145 {
    private static String pulsarBrokerUrl = "pulsar://127.0.0.1:6650";
    private static String pulsarServiceUrl = "http://127.0.0.1:8080";
    static final String TOPIC_NAME = "partitioned_topic_25145";
    ...
    public static void main(String[] args) throws PulsarClientException, InterruptedException, PulsarAdminException {
        for (int i = 0; i < 1000; i++) {
            ...
            ackCounters.values().forEach(count -> count.set(0));
        }
    }

    private static void runOnce() throws PulsarClientException, PulsarAdminException, InterruptedException {
        ...
        boolean inconsistentFound = false;
    ...
    static void consumerTask(PulsarClient client, String subscriptionName) {
        ...
        try {
//            while (ackCounters.get(subscriptionName).get() < sentMessageIds.size()) {
